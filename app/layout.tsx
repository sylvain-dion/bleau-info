...
export default function RootLayout({
  ...
  return (
    <html lang="fr" suppressHydrationWarning>
      ...
      >
        <MainNavProvider>
          <header className="sticky top-0 z-50 flex items-center justify-between gap-3 border-b border-border bg-background/95 px-4 py-3 backdrop-blur supports-[backdrop-filter]:bg-background/60">
