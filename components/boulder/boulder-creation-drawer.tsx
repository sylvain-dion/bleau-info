...
interface BoulderCreationDrawerProps {
  ...
  /** When provided, the form opens in edit mode for this draft. */
  editDraftId?: string
}

/**
 * Bottom-sheet drawer for creating or editing a boulder.
 *
 ...
 */
export function BoulderCreationDrawer({ open, onOpenChange, editDraftId }: BoulderCreationDrawerProps) {
  return (
      ...
      <Drawer.Portal>
        ...
        >
          <Drawer.Title className="sr-only">
            {editDraftId ? 'Modifier le brouillon' : 'Créer un nouveau bloc'}
          </Drawer.Title>
